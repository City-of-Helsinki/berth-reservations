...
env = environ.Env(
    ...
    BERTH_APPLICATION_PRIORITY_RESET_CRONJOB_ENABLED=(bool, False),
    PAYMENTS_REMINDER_NOTIFICATION_CRONJOB_ENABLED=(bool, False),
...
BERTH_APPLICATION_PRIORITY_RESET_CRONJOB_ENABLED = env(
    "BERTH_APPLICATION_PRIORITY_RESET_CRONJOB_ENABLED"
)
PAYMENTS_REMINDER_NOTIFICATION_CRONJOB_ENABLED = env(
    "PAYMENTS_REMINDER_NOTIFICATION_CRONJOB_ENABLED"
)
...
EXPIRE_WAITING_ORDERS_OLDER_THAN_DAYS = 3
EXPIRE_WAITING_OFFERS_OLDER_THAN_DAYS = 3
