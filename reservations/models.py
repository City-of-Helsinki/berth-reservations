...
class Reservation(models.Model):
    ...
    address = models.CharField(
        verbose_name=_('address'), max_length=150, blank=True
    )
    zip_code = models.CharField(
        verbose_name=_('zip code'), max_length=64, blank=True
    )
    ...
    boat_type = models.ForeignKey(
        BoatType, verbose_name=_('boat type'), related_name='reservations',
    ...
    boat_name = models.CharField(
        verbose_name=_('boat name'), max_length=64, blank=True
    )
    ...
    rent_from = models.CharField(
        verbose_name=_('rent from'), max_length=64, blank=True
    )
    rent_till = models.CharField(
        verbose_name=_('rent till'), max_length=64, blank=True
    )
